...
Lexer.prototype = {
  ...
  unsupported: function () {
    var captures =
      /^(each|for|while|case|when|default|if|unless|else|mixin|extends|include|block|append|prepend|yield)\b/.exec(
        this.input,
      );
    var feature = captures && captures[1];
    if (!feature && /^\+[\s(]*[-\w#]/.test(this.input))
      feature = "mixin call (+)";
